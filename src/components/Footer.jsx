     ...
     <div className='w-full'>
        <div className='max-w-screen-xl mx-auto py-10 flex gap-32'>
            <div className='basis-1/2 '>
                    <h1 className='text-[12rem]  leading-none tracking-tight'>noticias.</h1>
            </div>
            <div className='basis-1/2 flex gap-4'>
                    ...
                    <div className='basis-1/2 flex flex-col items-end'>
                        <p className='text-right'>Noticias is a pioneering digital news agency driven by design and empowered by technology</p>
        ...
        <h1 className='mt-32  mb-10 text-6xl max-w-screen-xl mx-auto text-orange-600'> App developed and created by Raj Mishra</h1>
    </div>
  )
}
